...
class TestTODOViewSet(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_user = {"user_name": "superMan", "first_name": "Аслан", "last_name": "Муслимов", "email": "email@mail.ru"}
        self.user = Users.objects.create(**self.data_user)

        self.data_project = {"project_name": "test_project", "repository_url": "https://stackoverflow.com/", "users": self.user}
        self.project = Project.objects.create()

         
        self.data_todo = {"project_name": self.project, "text_to_do":"some text", "create_or_update":"2023-02-14", "user":self.user, "is_active": True}
        self.todo_for_update = TODO.objects.create(**self.data_todo)
        self.data_todo_put = {"project_name": self.todo_for_update.project_name_id, "text_to_do":"some text to change", "create_or_update":"2023-02-14", "user":self.todo_for_update.user_id, "is_active": False}
        self.url = '/api/todo/'
